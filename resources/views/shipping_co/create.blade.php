    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('shipping_co.store') }}" method="post">
                    @csrf
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                            <label for="name">Company Name *</label>
                            <input type="text" class="form-control {{ $errors->has('name') ? 'has-error' : ''}} "
                                   name="name" id="name" placeholder="Company Name" value="{{ old('name') }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('primary_email') ? 'has-error' : ''}}">
                            ...
                            <input type="text" class="form-control" name="primary_email" id="primary_email"
                                   placeholder="Company Primary Email" value="{{ old('primary_email') }}">
                        ...
                        <div class="form-group {{ $errors->has('tracking_url') ? 'has-error' : ''}}">
                            ...
                            <input type="text" class="form-control" name="tracking_url" id="tracking_url"
                                   placeholder="Tracking URL" value="{{ old('tracking_url') }}">
