             ...
             @csrf
              <div class="box-body">
                <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                  ...
                  <input type="text" class="form-control {{ $errors->has('name') ? 'has-error' : ''}} " name="name" id="name" placeholder="Supplier Name" value="{{ old('name') }}">
                  @if ($errors->has('name'))
                ...
                <div class="form-group {{ $errors->has('phone') ? 'has-error' : ''}}">
                  ...
                  <input type="text" class="form-control" name="phone" id="phone" placeholder="Supplier Phone" value="{{ old('phone') }}">
                  @if ($errors->has('phone'))
                 ...
                 <div class="form-group {{ $errors->has('primary_email') ? 'has-error' : ''}}">
                  ...
                  <input type="text" class="form-control" name="primary_email" id="primary_email" placeholder="Supplier Primary Email" value="{{ old('primary_email') }}">
                ...
                <div class="form-group {{ $errors->has('city_id') ? 'has-error' : ''}}">
                 ...
                 <div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
                  ...
                  <input type="text" class="form-control" name="address" id="address" placeholder="Supplier Address" value="{{ old('address') }}">
