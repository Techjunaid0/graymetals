        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Update Contract</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('invoice_no') ? 'has-error' : ''}}">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('invoice_no',$contract->invoice_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('contract_no') ? 'has-error' : ''}}">
                            ...
                            <input type="text" class="form-control" name="contract_no" id="contract_no"
                                   ...
                                   value="{{ old('contract_no',$contract->contract_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('supplier_name') ? 'has-error' : ''}}">
                            ...
                            <select class="form-control" id="supplier_name" name="supplier_name">
                                ...
                                @foreach ($supplier_names as $supplier)
                                    <option
                                        value="{{$supplier->name}}" {{ $supplier->name == old('supplier_name',$contract->supplier_name) ? 'selected' : ''}}>{{$supplier->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('no_of_containers') ? 'has-error' : ''}}">
                            ...
                            <input type="number" class="form-control" min="0" name="no_of_containers"
                                   ...
                                   placeholder="Contract No"
                                   value="{{ old('no_of_containers',$contract->no_of_containers) }}">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option
                                    value="loaded" {{ 'loaded' == old('status',$contract->status) ? 'selected' : ''}}>
                                    Loaded
                                </option>
                                <option
                                    value="not_loaded" {{ 'not_loaded' == old('status',$contract->status) ? 'selected' : ''}}>
                                    Not
                                    Loaded
                                </option>
                            </select>
                            ...
                            <select class="form-control" id="shipping_line" name="shipping_line">
                                ...
                                @if(!empty($carrier_names) && count($carrier_names) >0)
                                    @foreach ($carrier_names as $shipping)
                                        <option
                                            value="{{$shipping->carrier_name}}" {{ $shipping->carrier_name == old('shipping_line',$contract->shipping_line) ? 'selected' : ''}}>{{$shipping->carrier_name }}</option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('weight') ? 'has-error' : ''}}">
                            ...
                            <input type="number" class="form-control" min="0" name="weight" id="weight"
                                   ...
                                   value="{{ old('weight',$contract->weight) }}">
                        ...
                        <div class="form-group {{ $errors->has('invoice_value') ? 'has-error' : ''}}">
                            ...
                            <input type="number" class="form-control" min="0" name="invoice_value" id="invoice_value"
                                   ...
                                   oninput="validity.valid||(value='');"
                                   readonly
                                   value="{{ old('invoice_value',$contract->invoice_value) }}">
                        ...
                        <div class="form-group {{ $errors->has('container_no') ? 'has-error' : ''}}">
                            ...
                            <input type="text" class="form-control" name="container_no" id="container_no"
                                   ...
                                   value="{{ old('container_no',$contract->container_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('comments') ? 'has-error' : ''}}">
                            ...
                            > {{ old('comments',$contract->comments) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('other_info') ? 'has-error' : ''}}">
                            ...
                            >{{ old('other_info',$contract->other_info) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('steal') ? 'has-error' : ''}}">
                            ...
                            <input type="text" class="form-control" name="steal" id="steal"
                                   placeholder="Steal"
                                   value="{{ old('steal',$contract->steal) }}">
                            @if ($errors->has('steal'))
                        ...
                        <div class="form-group {{ $errors->has('payment_status') ? 'has-error' : ''}}">
                            ...
                            <select class="form-control" id="payment_status" name="payment_status">
                                <option
                                    value="paid" {{ 'paid' == old('payment_status',$contract->payment_status) ? 'selected' : ''}}>
                                    Paid
                                </option>
                                <option
                                    value="not_paid" {{ 'not_paid' == old('payment_status',$contract->payment_status) ? 'selected' : ''}}>
                                    Not
                                    Paid
                                </option>
                                <option
                                    value="partial_paid" {{ 'partial_paid' == old('payment_status',$contract->payment_status) ? 'selected' : ''}}>
                                    Partial
                                    Paid
                                </option>
                            </select>
